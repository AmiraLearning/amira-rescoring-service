...
pub mod core;
use core::word_level_alignment_core;
...
#[pyfunction(signature = (batch_expected_items, batch_ref_phons, batch_hyp_phons, batch_confidences))]
#[pyo3(text_signature = "(batch_expected_items, batch_ref_phons, batch_hyp_phons, batch_confidences)")]
fn batch_word_level_alignment(
    ...
    let results: Result<Vec<_>, _> = (0..batch_expected_items.len())
        ...
        .map(|i| -> PyResult<(Vec<String>, Vec<bool>, Vec<f32>)> {
            match word_level_alignment_core(
