...
class TrieNode:
    def __init__(self) -> None:
        ...
        Args:
            ...
            is_end_of_element: Whether the node is the end of an element.
...
class LongestMatchResult:
    """The result of a longest match search in a trie.

    Args:
        matched_element: The matched element.
        tokens_consumed: The number of tokens consumed.
    """
...
class PhoneticTrie:
    def __init__(self, *, phonetic_elements: list[str] | None = None) -> None:
        """Initialize the phonetic trie.

        Args:
            phonetic_elements: The phonetic elements to insert into the trie.
        """
    ...
    def _insert(self, *, element: str) -> None:
        ...
        Args:
            element: The element to insert into the trie.
        """
    ...
    def find_longest_match(self, *, tokens: list[str], start_index: int) -> LongestMatchResult:
        """Find the longest match for a list of tokens starting at a given index.

        Args:
            tokens: The list of tokens to search for a match.
            start_index: The index to start searching for a match.

        Returns:
            LongestMatchResult: The longest match result.
        """
        node: TrieNode = self.root
