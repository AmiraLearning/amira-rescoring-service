...
def test_cpu_engine_imports() -> None:
    from src.letter_scoring_pipeline.inference.engine import Wav2Vec2InferenceEngine  # noqa: F401
...
def test_triton_engine_import_guard() -> None:
    ...
    from src.letter_scoring_pipeline.inference.triton_engine import TritonInferenceEngine  # noqa: F401
