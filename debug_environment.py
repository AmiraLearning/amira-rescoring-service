...
from amira_pyutils.environment import Environments, construct_envs
...
def debug_construct_envs() -> None:
    ...
    print("1. Config file resolution:")
    ...
    try:
        staging_env = Environments.find("staging")  # type: ignore[attr-defined]
        if staging_env:
